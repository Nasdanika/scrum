...
/**
 * This is the item provider adapter for a {@link org.nasdanika.scrum.Member} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemberItemProvider extends ModelElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Member_assignments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Member_assignments_feature", "_UI_Member_type"),
				 ScrumPackage.Literals.MEMBER__ASSIGNMENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScrumPackage.Literals.MEMBER__PARTIES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Member.class)) {
			case ScrumPackage.MEMBER__PARTIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScrumPackage.Literals.MEMBER__PARTIES,
