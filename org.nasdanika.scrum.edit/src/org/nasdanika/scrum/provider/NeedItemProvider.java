...
/**
 * This is the item provider adapter for a {@link org.nasdanika.scrum.Need} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NeedItemProvider extends ModelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Need_satisfiedBy_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Need_satisfiedBy_feature", "_UI_Need_type"),
				 ScrumPackage.Literals.NEED__SATISFIED_BY,
				 true,
				 false,
				 true,
				 null,
