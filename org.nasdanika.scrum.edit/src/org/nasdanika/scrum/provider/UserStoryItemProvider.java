...
/**
 * This is the item provider adapter for a {@link org.nasdanika.scrum.UserStory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserStoryItemProvider extends FunctionalityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserStory_plannedFor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserStory_plannedFor_feature", "_UI_UserStory_type"),
				 ScrumPackage.Literals.USER_STORY__PLANNED_FOR,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScrumPackage.Literals.USER_STORY__TASKS);
		}
	...
	public String getText(Object object) {
		String label = ((UserStory)object).getName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScrumPackage.Literals.USER_STORY__TASKS,
