...
/**
 * This is the item provider adapter for a {@link org.nasdanika.scrum.Artifact} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArtifactItemProvider extends ModelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Artifact_owner_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Artifact_owner_feature", "_UI_Artifact_type"),
				 ScrumPackage.Literals.ARTIFACT__OWNER,
				 true,
				 false,
				 true,
				 null,
