...
/**
 * This is the item provider adapter for a {@link org.nasdanika.scrum.Task} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TaskItemProvider extends ModelElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_components_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_components_feature", "_UI_Task_type"),
				 ScrumPackage.Literals.TASK__COMPONENTS,
				 true,
				 false,
				 true,
				 null,
